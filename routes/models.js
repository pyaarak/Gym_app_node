...
const Fulldetails={
    Users:db.define('User_details',{id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true }, name: { type: DataTypes.STRING }, email: { type: DataTypes.STRING }, contact: { type: DataTypes.STRING }, gender: { type: DataTypes.STRING }, package: { type: DataTypes.STRING }, expirydate: { type: DataTypes.STRING }, status: {type:DataTypes.STRING}}),
    Report:db.define('Report',{id:{ type:DataTypes.INTEGER, primaryKey:true, autoIncrement:true}, report_document: {type:DataTypes.STRING},attendance_document:{type:DataTypes.STRING},reportdate:{type:DataTypes.STRING},attendancedate:{type:DataTypes.STRING},reportcycle:{type:DataTypes.STRING},attandancecycle:{type:DataTypes.STRING},reportremaider:{type:DataTypes.STRING},attendanceremainder:{type:DataTypes.STRING},status:{type:DataTypes.STRING}}),
